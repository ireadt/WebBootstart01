...
namespace ConsoleAPI
{
    class Program
    {
        ...
        {
            string appkey = "290169713ae8ec5a978a8c8285417f4a"; //配置您申请的appkey
            ...
            parameters3.Add("ip", "58.215.185.154"); //ip地址，如：58.215.185.154
            ...
            parameters4.Add("lon", "116.39277"); //经度，如：116.39277
            parameters4.Add("lat", "39.933748"); //纬度，如：39.933748
            parameters4.Add("format", "1"); //未来6天预报(future)两种返回格式，1或2，默认1
            parameters4.Add("dtype", "json"); //返回数据格式：json或xml,默认json
